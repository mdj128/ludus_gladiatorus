...
const charPath = 'static/tiled/sprites/sprites.png';
...
export default () => {
  ...
  return (
    <div onMouseMove={onMouseMove} className="pixi-container">
      ...
      >
        ...
        >
          <Character x={charX} y={charY} scale={4} imageUrl={charPath} />
        </TiledMapContainer>
      </Stage>
    </div>
  );
